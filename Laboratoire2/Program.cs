        ...
        { 
            ...
            do
            {
                ...
                do
                {
                    ...
                    {
                        if (dernierTour == false || nouveauTour != false) Console.WriteLine("VOTRE ADVERSAIRE SIGNALE LA FIN DE CETTE MANCHE !!!");
                        dernierTour = true;
                    }
                ...
                if (joueur1.nbreVie == 0 || joueurPC.nbreVie == 0) nouvelleManche = false;
            } while (nouvelleManche);
            if(joueur1.nbreVie==0) Console.WriteLine(" VOUS AVEZ PERDUE CETTE PARTIE !!!");
            else Console.WriteLine(" VOUS AVEZ GAGNE CETTE  PARTIE !!!");
